...
// ── Public navbar (transparent → khatulistiwa on scroll) ───────────────────────
  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-khatulistiwa-950/95 backdrop-blur-md border-b border-white/10 shadow-lg"
...
function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{ background: HERO_BG }} aria-label="Hero Lantara">
      ...
      >
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-terakota-500/40 text-terakota-300 text-xs font-semibold px-4 py-1.5 rounded-full mb-8">
          <span className="h-1.5 w-1.5 rounded-full bg-terakota-500 animate-pulse" aria-hidden="true" />
