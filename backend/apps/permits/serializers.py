...
class IssuedPermitPublicSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "validation_uuid",
            "permit_type_name", "sektor_name",
            "applicant_name", "reference_number",
            "signatory_name", "signatory_title",
            "generation_status", "published_at",
        ]
...
class IssuedPermitDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = IssuedPermit
        fields = [
            "id", "validation_uuid", "generation_status",
            "signatory_name", "signatory_title", "signatory_nip",
            "signed_at", "published_at", "copy_recipients",
